...
Array RPCConvertValues(const std::string &strMethod, const std::vector<std::string> &strParams)
{
    ...
    if (strMethod == "setusepok"              && n > 0) ConvertTo<bool>(params[0]);
    ...
    if (strMethod == "getaccountaddress"      && n > 1) ConvertTo<bool>(params[1]);
    ...
    if (strMethod == "listunspent"            && n > 3) ConvertTo<bool>(params[3], true);
    ...
    if (strMethod == "gettotalcoins"          && n > 0) ConvertTo<bool>(params[0]);
...
std::string HelpMessageCli(bool mainProgram)
{
    ...
    strUsage += "  -rpcport=<port>        " + _("Connect to JSON-RPC on <port> (default: 10332 or testnet: 11332)") + "\n";
