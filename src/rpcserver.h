...
extern json_spirit::Value getusepok(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value setusepok(const json_spirit::Array& params, bool fHelp);
...
extern json_spirit::Value gettotalcoins(const json_spirit::Array& params, bool fHelp);
