...
BOOST_AUTO_TEST_CASE(compress_amounts)
{
    ...
    BOOST_CHECK(TestPair(         CENT*1000,       0x7));
    BOOST_CHECK(TestPair(         COIN*1000,       0x9));
    BOOST_CHECK(TestPair(      50*COIN*1000,      0x32));
    BOOST_CHECK(TestPair(21000000*COIN*1000, 0x1406f40));
