...
const QString BITCOIN_IPC_PREFIX("ziftrcoin:");
const char* BITCOIN_REQUEST_MIMETYPE = "application/ziftrcoin-paymentrequest";
const char* BITCOIN_PAYMENTACK_MIMETYPE = "application/ziftrcoin-paymentack";
const char* BITCOIN_PAYMENTACK_CONTENTTYPE = "application/ziftrcoin-payment";
...
bool PaymentServer::ipcParseCommandLine(int argc, char* argv[])
{
    for (int i = 1; i < argc; i++)
    {
        ...
        if (arg.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // ziftrcoin: URI
        {
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click ziftrcoin: links
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start ziftrcoin: click-to-pay handler"));
        }
        else {
...
//
// OSX-specific way of handling ziftrcoin: URIs and
// PaymentRequest mime types
//
bool PaymentServer::eventFilter(QObject *object, QEvent *event)
{
    // clicking on ziftrcoin: URIs creates FileOpen events on the Mac
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in ziftrcoin: URIs
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // ziftrcoin: URI
    {
#if QT_VERSION < 0x050000
        QUrl uri(s);
#else
