...
// TODO fix help message and fix to give work
...
Value getblocktemplate(const Array& params, bool fHelp)
{
    ...
    Object result;
    result.push_back(Pair("version", (int64_t)pblock->GetVersion()));
    ...
    result.push_back(Pair("sigoplimit", (int64_t)chainActive.TipMaxBlockSize()));
    result.push_back(Pair("sizelimit", (int64_t)chainActive.TipMaxBlockSigOps()));
